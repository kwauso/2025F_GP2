...
ブロックチェーンにおいて、個々のブロックの整合性を担保するために使用されているのも、ハッシュチェーンである~\cite{bitcoin}。
\subsection{公開鍵暗号}
...
そこで登場するのがウォレットアプリケーションであり、HolderがIssuerから発行されたデジタル証明書を格納してVerifierに提示するのに用いられる~\cite{IdentityWallet_paper}。
