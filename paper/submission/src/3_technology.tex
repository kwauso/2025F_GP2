...
\\
　また、ハッシュ値を用いた技術としてハッシュチェーンが存在する。
ハッシュチェーンは、連続するハッシュ値を順番に連結して作られるチェーン状のデータ構造であり、含まれるデータの整合性を保ち、改ざんの検知が可能である。
ブロックチェーンにおいて、個々のブロックの整合性を保証するために使用されているのも、ハッシュチェーンである。
\subsection{公開鍵暗号}
