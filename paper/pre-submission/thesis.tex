...
% タイトル
\def\title{コネクティッドカーにおける運転歴データの管理・提示システムの構築}
% 英語タイトル
\def\etitle{Building a System for Managing and Presenting Driving History Data in Connected Cars}
% 著者(日本語)
\def\author{仁戸田晃}
% 著者(英語)
\def\eauthor{Akira Nieda}
% 学部・研究科
...
\input{src/3_technology}
\input{src/4_issue}
\input{src/5_proposed}
\input{src/6_implementation}
\input{src/7_evaluation}
